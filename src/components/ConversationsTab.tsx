    ...
    <div class="space-y-4 pb-4">
      ...
      <div class="space-y-2 max-h-[calc(100vh-200px)] overflow-y-auto">
        {props.conversations.map((conv) => (
          <div
            class={clsx(
              "w-full text-left p-3 rounded-lg transition duration-300 group relative",
          ...
          >
            ...
            <button
              ...
              class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-red-400 opacity-0 group-hover:opacity-100 transition-opacity duration-200"
            >
